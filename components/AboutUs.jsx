 ...
 export default function AboutUs() {
   return (
     <section className="text-white py-16 px-6 md:px-12 lg:px-24">
       ...
       <div className="flex md:flex-wrap justify-center gap-8 md:gap-12 mb-12">
         {[
           ...
           <div key={index} className="flex flex-col items-center">
             <div className=" rounded-full flex items-center justify-center">
               <Image
                 ...
                 width={300}
                 height={300}
                 className="xs:w-1/2 xs:h-1/2 sm:w-3/4 sm:h-3/4 md:w-full md:h-full object-contain"
               />
             </div>
             <span
             ...
             <span
               className={`${Iceland_font.className} text-base text-center sm:text-2xl mt-[-2px] sm:mt-[-12px]`}
             >
               {stat.text}
             </span>
           </div>
