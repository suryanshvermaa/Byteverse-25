  ...
  return (
    <section className="text-white py-16 px-6 md:px-12 lg:px-24">
      <div className="relative flex justify-center items-center mb-12">
        ...
        <h2 className={` ${Iceland_font.className} relative text-4xl sm:text-4xl md:text-6xl font-bold uppercase text-center px-4`}>
          About Us
        </h2>
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-8 md:gap-16 mb-12">
        {[
          { number: "6+", text: "Themes" },
          { number: "36+", text: "Hours of Hacking" },
          { number: "1.8k+", text: "Participants" },
        ].map((stat, index) => (
          <div key={index} className="flex flex-col items-center">
            ...
            <p className={` ${Iceland_font.className}   sm:text-7xl font-bold -mt-6`}>{stat.number}</p>
            <p className={` ${Iceland_font.className} text-2xl -mt-3 `}>{stat.text}</p>
          </div>
        ))}
      </div>
